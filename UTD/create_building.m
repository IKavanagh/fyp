...
building(1:1+w_dy, 1:N) = 0;
building(M:-1:M-w_dy, 1:N) = 0;
building(1:M, 1:1+w_dx) = 0;
building(1:M, N:-1:N-w_dx) = 0;

% Create 2 column layout
building(1:hN,1:hN) = 1;
...
building(eM:qM, hN+3*w_dx/8:hN+5*w_dx/8) = 0 ; 
building(3*eM:hM, hN+3*w_dx/8:hN+5*w_dx/8) = 0 ;
building(5*eM:3*qM, hN+3*w_dx/8:hN+5*w_dx/8) = 0 ;
building(7*eM:M, hN+3*w_dx/8:hN+5*w_dx/8) = 0 ;
end


scatterer = sum(sum(building)) ;
fprintf(1,'There are %d of %d active unknowns \n',scatterer,problem_size) ; 
